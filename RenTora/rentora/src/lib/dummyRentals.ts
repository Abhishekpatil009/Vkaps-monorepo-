...
export const MOCK_RENTAL_ITEMS: RentalItem[] = 
[
  // 1. Cameras
  {
    id: "item-1",
  ...
  },
  {
    ...
    "ownerId": "user-104",
    "description": "First-person view drone experience. Includes Goggles V2 and motion controller. 4K/60fps recording."
 },
  {
    id: "item-35",
  ...
  // 38. Drones (FPV)
 {
    ...
    "securityDeposit": 50,
    "rating": 4.7,
    "image": "https://images.unsplash.com/photo-1526297003708-f5a1c2c9c6e7?auto=format&fit=crop&q=80&w=1200",
    "ownerId": "user-106",
    "description": "Rapid cooking stove for backpacking. Boils water in 100 seconds. Includes fuel canister stabilizer."
 },
  // 39. Cameras (Lens)
  {
    id: "item-39",
  ...
  // 42. Electronics (Connectivity)
 {
    ...
    "securityDeposit": 600,
    "rating": 4.9,
    "image": "https://images.unsplash.com/photo-1621330396173-e41b1cafd17f?auto=format&fit=crop&q=80&w=1200",
    "ownerId": "user-119",
    "description": "High-speed satellite internet anywhere. Perfect for remote work while camping or RVing."
 },
  // 43. Tools (Tiling)
  {
    id: "item-43",
  ...
  // 44. Bikes (Cargo)
  {
    ...
    "securityDeposit": 150,
    "rating": 4.8,
    "image": "https://images.unsplash.com/photo-1523983388277-336a66bf9bcd?auto=format&fit=crop&q=80&w=1200",
    "ownerId": "user-106",
    "description": "Anti-gravity suspension system makes heavy loads feel light. Size Medium. Rain cover included."
 },
{
    "id": "item-44",
    ...
    "ownerId": "user-114",
    "description": "Haul kids or groceries. 350 lb capacity. 45+ miles range per charge. Includes running boards."
 },
 ...
 
  {
    ...
    securityDeposit: 700,
    rating: 4.9,
    image: "https://images.unsplash.com/photo-1661961111184-11317b40adb2?auto=format&fit=crop&q=80&w=800",
    ownerId: "user-103",
    description: "Ultra-portable, fanless design. incredible battery life. 512GB SSD. Perfect for students.",
  },
  {
    id: "item-47",
    ...
    securityDeposit: 200,
    rating: 4.7,
    image: "https://images.unsplash.com/photo-1517176102644-78550958d7e0?auto=format&fit=crop&q=80&w=800",
    ownerId: "user-108",
    description: "Stable touring SUP. 11 feet long. Comes with carbon paddle, pump, and travel bag.",
  },
  {
    id: "item-48",
    ...
    ownerId: "user-113",
    description: "88 weighted keys with authentic piano sound. Includes sustain pedal and X-stand.",
  },
  {
    id: "item-50",
    ...
    ownerId: "user-105",
    description: "Heavy duty drum sander for refinishing hardwood floors. Sandpaper belts sold separately.",
  },
  {
    id: "item-52",
    ...
    ownerId: "user-116",
    description: "2-in-1 tablet and laptop. 120Hz touch screen. Includes Signature Keyboard and Slim Pen 2.",
  },
  {
    id: "item-55",
    ...
    ownerId: "user-109",
    description: "Compact wireless microphone system. Includes two transmitters and one receiver. Great for vloggers.",
  },
  {
    id: "item-58",
    ...
    ownerId: "user-122",
    description: "Computerized telescope. Auto-aligns to track planets and stars. Great for viewing Saturn or Jupiter.",
  },
  {
    id: "item-60",
    ...
    ownerId: "user-110",
    description: "High-speed photo scanner. Digitizes 1 photo per second. Perfect for archiving old family albums.",
  }
];
